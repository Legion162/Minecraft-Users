 ...
 * ```
 */
export declare const getAllDistances: (fromCoordinates: CoordinatesXY | null, ...toCoordinates: CoordinatesXY[]) => GetAllDistancesReturn[];
export {};
//# sourceMappingURL=getAllDistances.d.ts.map