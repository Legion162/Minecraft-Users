...
export const Example = props => {
  ...
  const truncated = useMemo(() => truncDecimals(number, maxDecimalPlaces), [number, maxDecimalPlaces]);
  ...
  }, isNaN(truncated) ? "Error" : truncated))), /*#__PURE__*/React.createElement(Source, {
    dark: true,
    code: `
