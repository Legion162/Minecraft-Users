...
describe("getFrequency", () => {
  ...
  test("Get the frequency of mixed types of values in an array", () => {
    expect(getFrequency(["lorem ipsum", 4, true, true, "lorem ipsum", false, "lorem ipsum", false, 8, 8, 15, false, 16, undefined, 23, null, 23, null, "lorem ipsum", 42, 42, 42, "lorem ipsum", "dolor sit amet", "dolor sit amet"])).toMatchObject([{
      frequency: 1,
      value: 4
    }, {
      frequency: 1,
  ...
  test("Get the frequency of an array of 1 number", () => {
    expect(getFrequency([4])).toMatchObject([{
      frequency: 1,
      value: 4
    }]);
  });
