 ...
 * ```
 */
export const getConeArea = function (radius, height) {
  let excludeBottom = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  return Math.PI * radius * height + (excludeBottom ? 0 : getCircleArea(radius));
};
//# sourceMappingURL=getConeArea.js.map