 ...
 * **Basic usage:**
 * ```ts
 * import { getDistanceOnEarth } from "@baggie/core";
 *
 ...
 * ```
 */
export const getDistanceOnEarth = (from, to) => getDistanceOnSphere(from, to, 12742);
//# sourceMappingURL=getDistanceOnEarth.js.map