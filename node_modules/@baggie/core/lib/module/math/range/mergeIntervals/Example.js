...
export const Example = props => {
  ...
  }, JSON.stringify(result)))), /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("input", {
    type: "checkbox",
...
const ranges = ${realRanges.length === 1 ? JSON.stringify(realRanges[0], null, 4) : JSON.stringify(realRanges, null, 4)};
