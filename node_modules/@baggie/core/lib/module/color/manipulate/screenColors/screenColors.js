 ...
 */
export const screenColors = (colorA, colorB) => {
  try {
    const rgb1 = typeof colorA === "string" ? convertStringToRgb(colorA) : colorA;
    const rgb2 = typeof colorB === "string" ? convertStringToRgb(colorB) : colorB;
...
//# sourceMappingURL=screenColors.js.map