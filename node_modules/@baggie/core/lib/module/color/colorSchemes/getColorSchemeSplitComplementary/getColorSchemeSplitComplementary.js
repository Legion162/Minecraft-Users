 ...
 */
export const getColorSchemeSplitComplementary = color => {
  ...
  return [hex, convertRgbToHex(convertHslToRgb({
    hue: (hue + 72) % 360,
    saturation,
    lightness,
    alpha
  })), convertRgbToHex(convertHslToRgb({
    hue: (hue + 216) % 360,
    saturation,
    lightness,
    alpha
...
//# sourceMappingURL=getColorSchemeSplitComplementary.js.map