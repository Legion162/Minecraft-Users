...
describe("intersperse", () => {
  ...
  test("Insert multiple values", () => {
    expect(intersperse([10, 15], 11, 12, 13, 14)).toStrictEqual([10, 11, 12, 13, 14, 15]);
    expect(intersperse([10, 15], ...["11", 12, "13", 14])).toStrictEqual([10, "11", 12, "13", 14, 15]);
  });
  test("Insert value with function", () => {
    expect(intersperse([10, 12], _ref => {
      let {
        previous,
        next
      } = _ref;
    ...
    expect(intersperse([1, 2, 3, 4], _ref2 => {
      let {
        previous,
        next
      } = _ref2;
    ...
    expect(intersperse([1, 2, 3, 4], ...[_ref3 => {
      let {
        previous,
        next
      } = _ref3;
      return previous + (next - previous) / 2;
    }, "hello"])).toStrictEqual([1, 1.5, "hello", 2, 2.5, "hello", 3, 3.5, "hello", 4]);
  });
});
//# sourceMappingURL=intersperse.test.js.map