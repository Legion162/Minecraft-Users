...
const Example = props => {
  ...
  const [weight, setWeight] = (0, _react.useState)(props.weight);
  const mixed = (0, _react.useMemo)(() => (0, _mixColors.mixColors)(colorA, colorB, weight), [colorA, colorB, weight]);
  ...
  }), " ", weight.toFixed(2))), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      marginTop: "25px"
    }
