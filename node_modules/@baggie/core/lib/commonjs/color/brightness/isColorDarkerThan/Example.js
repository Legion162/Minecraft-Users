...
var _isColorDarkerThan = require("./isColorDarkerThan");
...
const Example = props => {
  const [colorA, setColorA] = (0, _react.useState)(props.colorA);
  const [colorB, setColorB] = (0, _react.useState)(props.colorB);
  const isDarker = (0, _react.useMemo)(() => (0, _isColorDarkerThan.isColorDarkerThan)(colorA, colorB), [colorA, colorB]);
  ...
  }, isDarker ? "true" : "false"))), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      marginTop: "25px"
    }
