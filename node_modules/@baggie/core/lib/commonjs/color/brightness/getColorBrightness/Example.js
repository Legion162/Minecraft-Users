...
var _getColorBrightness = require("./getColorBrightness");
...
const Example = props => {
  ...
  const brightness = (0, _react.useMemo)(() => (0, _getColorBrightness.getColorBrightness)(color), [color]);
  ...
  }, brightness))), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
