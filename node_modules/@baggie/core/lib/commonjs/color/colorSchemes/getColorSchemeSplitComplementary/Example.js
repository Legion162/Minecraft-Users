...
var _getColorSchemeSplitComplementary = require("./getColorSchemeSplitComplementary");
...
const Example = props => {
  ...
  const scheme = (0, _react.useMemo)(() => {
    try {
      return (0, _getColorSchemeSplitComplementary.getColorSchemeSplitComplementary)(color);
    } catch (err) {
      return [];
    }
  }, [color]);
