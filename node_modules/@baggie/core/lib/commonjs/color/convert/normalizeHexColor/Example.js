...
var _normalizeHexColor = require("./normalizeHexColor");
...
const Example = props => {
  const [hex, setHex] = (0, _react.useState)(props.hex);
  const normalized = (0, _react.useMemo)(() => (0, _normalizeHexColor.normalizeHexColor)(hex), [hex]);
  ...
  }, normalized ? normalized : "undefined")), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
