...
const Example = props => {
  ...
  const [multipleOf, setMultipleOf] = (0, _react.useState)(props.multipleOf);
  const result = (0, _react.useMemo)(() => (0, _floorToMultipleOf.floorToMultipleOf)(number, multipleOf), [number, multipleOf]);
