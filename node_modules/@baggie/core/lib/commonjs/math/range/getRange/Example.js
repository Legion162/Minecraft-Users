...
const Example = props => {
  const [input, setInput] = (0, _react.useState)(props.numbers.join(", "));
  const {
    numbers,
    range
  } = (0, _react.useMemo)(() => {
    ...
    return {
      numbers,
      range: (0, _getRange.getRange)(numbers)
    };
  }, [input]);
  ...
  }, isNaN(range) ? "Error" : range))), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
