...
var _getAntiMode = require("./getAntiMode");
...
const Example = props => {
  const [input, setInput] = (0, _react.useState)(props.defaultInput.join(", "));
  const {
    numbers,
    result
  } = (0, _react.useMemo)(() => {
    ...
    return {
      numbers,
      result: (0, _getAntiMode.getAntiMode)(numbers)
    };
  }, [input]);
  ...
  }, result ? `[${result.numbers.join(", ")}]` : "Error"))), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
