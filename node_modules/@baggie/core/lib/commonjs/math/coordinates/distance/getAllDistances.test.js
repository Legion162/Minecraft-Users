...
var _getAllDistances = require("./getAllDistances");
describe("getAllDistances", () => {
  test("Find distances from specific position", () => {
    expect((0, _getAllDistances.getAllDistances)({
      x: 9,
      y: 30
    }, {
      x: 10,
  ...
  test("Find distances between a bunch of position", () => {
    expect((0, _getAllDistances.getAllDistances)(null, {
      x: -10,
      y: -10,
      name: "a"
    }, {
...
//# sourceMappingURL=getAllDistances.test.js.map