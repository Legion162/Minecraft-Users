...
var _nonNumberFallback = require("./nonNumberFallback");
...
const Example = props => {
  ...
  const [fallback, setFallback] = (0, _react.useState)(props.defaultFallback);
  const output = (0, _react.useMemo)(() => (0, _nonNumberFallback.nonNumberFallback)(input, fallback), [input, fallback]);
  ...
  }, output))), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
