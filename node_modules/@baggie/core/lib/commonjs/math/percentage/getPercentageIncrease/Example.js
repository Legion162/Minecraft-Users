...
var _getPercentageIncrease = require("./getPercentageIncrease");
...
const Example = props => {
  const [from, setFrom] = (0, _react.useState)(props.from);
  const [to, setTo] = (0, _react.useState)(props.to);
  const [percentageAsDecimal, setPercentageAsDecimal] = (0, _react.useState)(true);
  const result = (0, _react.useMemo)(() => (0, _getPercentageIncrease.getPercentageIncrease)(from, to, percentageAsDecimal), [from, to, percentageAsDecimal]);
