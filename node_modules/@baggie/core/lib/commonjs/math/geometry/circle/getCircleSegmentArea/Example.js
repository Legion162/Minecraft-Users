...
var _getCircleSegmentArea = require("./getCircleSegmentArea");
...
const Example = props => {
  ...
  const [height, setHeight] = (0, _react.useState)(props.height);
  const surfaceArea = (0, _react.useMemo)(() => (0, _getCircleSegmentArea.getCircleSegmentArea)(radius || 0, height || 0), [radius, height]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, isNaN(surfaceArea) ? "Error" : surfaceArea))), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      aspectRatio: 1,
      background: "#FC0",
      marginTop: "20px",
    ...
    style: {
      ...
      transform: `translateY(${isNaN(surfaceArea) ? 0 : 100 - (0, _getPercentage.getPercentage)({
        part: height,
        whole: radius * 2
      }, false)}%)`,
  ...
  }, "r = ", radius || 0))), /*#__PURE__*/_react.default.createElement(_blocks.Source, {
    dark: true,
    code: `
