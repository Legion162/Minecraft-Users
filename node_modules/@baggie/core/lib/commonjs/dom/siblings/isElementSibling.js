...
exports.isElementSibling = void 0;
 ...
 */
const isElementSibling = function (element1, element2) {
  let adjacentOnly = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  if (adjacentOnly) {
  ...
  const siblingElements = (0, _getElementSiblings.getElementSiblings)(element1);
...
exports.isElementSibling = isElementSibling;
//# sourceMappingURL=isElementSibling.js.map