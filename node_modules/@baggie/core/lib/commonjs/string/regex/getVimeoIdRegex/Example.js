...
var _getVimeoIdRegex = require("./getVimeoIdRegex");
...
const Example = props => {
  ...
  const match = (0, _react.useMemo)(() => string.match((0, _getVimeoIdRegex.getVimeoIdRegex)()), [string]);
...
`
    ...
    dark: true,
    code: `new RegExp("${(0, _getVimeoIdRegex.getVimeoIdRegex)().source}", "${(0, _getVimeoIdRegex.getVimeoIdRegex)().flags}")`
  }));
};
