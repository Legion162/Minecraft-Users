...
const Example = props => {
  ...
  const match = (0, _react.useMemo)(() => string.match((0, _getYouTubeIdRegex.getYouTubeIdRegex)()), [string]);
...
`
    ...
    dark: true,
    code: `new RegExp("${(0, _getYouTubeIdRegex.getYouTubeIdRegex)().source}", "${(0, _getYouTubeIdRegex.getYouTubeIdRegex)().flags}")`
  }));
};
