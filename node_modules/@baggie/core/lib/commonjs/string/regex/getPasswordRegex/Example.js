...
const Example = props => {
  ...
  const {
    ...
    return {
      ...
      isValid: (0, _getPasswordRegex.getPasswordRegex)(optionsObj).test(password)
    };
...
`
    ...
    dark: true,
    code: `new RegExp("${(0, _getPasswordRegex.getPasswordRegex)(options).source}", "${(0, _getPasswordRegex.getPasswordRegex)(options).flags}")`
  }));
};
