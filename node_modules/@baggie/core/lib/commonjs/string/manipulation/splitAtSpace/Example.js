...
var _splitAtSpace = require("./splitAtSpace");
...
const Example = props => {
  ...
  const [nearestIndex, setNearestIndex] = (0, _react.useState)(props.nearestIndex);
  const output = (0, _react.useMemo)(() => (0, _splitAtSpace.splitAtSpace)(string, nearestIndex), [string, nearestIndex]);
