...
var _decodeCookiePart = require("./_helpers/decodeCookiePart.helper");
/**
 * Get a cookie.
 *
...
const getCookie = function (name) {
  let dontParseCookie = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  cookies.forEach(cookie => {
    ...
    if (!name || typeof cookieJar[name] === "undefined") {
      ...
      try {
        const decodedName = (0, _decodeCookiePart.decodeCookieParts)(cookieName);
        cookieValue = (0, _decodeCookiePart.decodeCookieParts)(cookieValue);
        if (!dontParseCookie) {
          // Try parsing cookie
          try {
